...
@pytest.mark.parametrize(
    ...
    argvalues=[
        ...
        (["tests/test_files/pic.png", "-C", "-h", "nothingtoseehere"]),
        ...
        (["tests/test_files/pic.png", "-C", "-h", "questionablelink"]),
        (["tests/test_files/pic.png", "-C", "-h", "reeeeee"]),
        (["tests/test_files/pic.png", "-C", "-h", "screenshotting"]),
        (["tests/test_files/pic.png", "-C", "-h", "smms"]),
        (["tests/test_files/pic.png", "-C", "-h", "sxcu"]),
        (["tests/test_files/pic.png", "-C", "-h", "telegraph"]),
        (["tests/test_files/pic.png", "-C", "-h", "up2sha"]),
        (["tests/test_files/pic.png", "-C", "-h", "uplio"]),
        (["tests/test_files/pic.png", "-C", "-h", "whyamihere"]),
    ],
)
